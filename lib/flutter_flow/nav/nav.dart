...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Center(
                  child: Image.asset(
                    'assets/images/Desain_tanpa_judul_1.png',
                    width: 250.0,
                    fit: BoxFit.cover,
                  ),
                ),
      ...
      routes: [
        ...
        FFRoute(
          name: 'c_Login',
          path: '/cLogin',
          builder: (context, params) => const CLoginWidget(),
        ),
        FFRoute(
          name: 'd_Register',
          path: '/dRegister',
          builder: (context, params) => const DRegisterWidget(),
        ),
        FFRoute(
          name: 'e_LupaPw',
          path: '/eLupaPw',
          builder: (context, params) => const ELupaPwWidget(),
        ),
        FFRoute(
          name: 'b_OnBoarding',
          path: '/bOnBoarding',

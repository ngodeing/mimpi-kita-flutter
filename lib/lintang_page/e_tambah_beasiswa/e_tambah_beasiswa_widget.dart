...
class ETambahBeasiswaWidget extends StatefulWidget {
  const ETambahBeasiswaWidget({super.key});

  @override
  State<ETambahBeasiswaWidget> createState() => _ETambahBeasiswaWidgetState();
}

class _ETambahBeasiswaWidgetState extends State<ETambahBeasiswaWidget> {
  late ETambahBeasiswaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ETambahBeasiswaModel());
